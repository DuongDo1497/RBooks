          ...
          <div class="col-xxl-8">
            <div class="card account-body favorite">
              <div class="card-header">
                <h4 class="info-title">{{ trans('home.Sản phẩm yêu thích') }}</h4>
              </div>
              <div class="card-body">
          ...
          <div class="profile">
            ...
            <div class="favorite-box">
              @foreach ($customer->productlikes as $product)
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-12"><img
                  ...
                  <button type="button" class="close close-box" data-toggle="modal" aria-label="Close"
                    onclick="window.location.href='{{ route('del-wish', ['id' => $product->id]) }}'">
