          ...
          <div class="col-xxl-8">
            <div class="card account-body profile">
              <div class="card-header">
                <h4 class="info-title">{{ trans('home.Thông tin của tôi') }}</h4>
                <p class="desc-info">{{ trans('home.Quản lý thông tin để bảo mật tài khoản') }}</p>
              </div>
              <div class="card-body">
                ...
                <form action="{{ route('customer-update') }}" method="post">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="input" class="form-control input-info input-info--name" name="name"
                          value="{{ $customer->fullname }}" placeholder="{{ trans('home.Nhập họ và tên') }}">
                      </div>
                    </div>
                  ...
                  <div class="form-group mt-3">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control input-info input-info__phone" name="phone"
                          value="{{ $customer->phone }}" disabled="true">
                      </div>
                      <div class="col-sm-3 btn-info-change">
                        <a data-bs-toggle="modal" data-bs-target="#infoPhone"
                          class="btn-change--phone">{{ trans('home.Thay đổi') }}</a>
                      </div>
                    </div>
                  </div>
                  <div class="form-group mt-3">
                    <div class="row">
                      ...
                      <div class="col-sm-4 mr-2">
                        <input id="user-phone-info" type="input" class="form-control input-info input-info__phone"
                          name="email" title="{{ $customer->email }}" value="{{ $customer->email }}" disabled="true">
                        <input type="input" class="form-control input-info" name="email"
                          value="{{ $customer->email }}" hidden="true">
                      </div>
                  ...
                  <div class="form-group mt-3">
                    <div class="row">
                      <div class="col-sm-3 label-input">
                        <label>{{ trans('home.Tên công ty') }}</label>
                      </div>
                      <div class="col-sm-6">
                        <input type="input" class="form-control input-info " name="name_company"
                          value="{{ $customer->companies->name ?? '' }}"
                          placeholder="{{ trans('home.Nhập tên công ty') }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group mt-3">
                    <div class="row">
                      <div class="col-sm-3 label-input">
                        <label>{{ trans('home.Địa chỉ công ty') }}</label>
                      </div>
                      <div class="col-sm-6">
                        <input type="input" class="form-control input-info" name="address_company"
                          value="{{ $customer->companies->address_company ?? '' }}"
                          placeholder="{{ trans('home.Nhập địa chỉ công ty') }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group mt-3">
                    <div class="row">
                      <div class="col-sm-3 label-input">
                        <label>{{ trans('home.Mã số thuế') }}</label>
                      </div>
                      <div class="col-sm-6">
                        <input type="input" class="form-control input-info" name="vat_code"
                          value="{{ $customer->companies->code_vat ?? '' }}"
                          placeholder="{{ trans('home.Nhập mã số thuế') }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group mt-4">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <button class="btn btn-danger btn-save-info " type="submit">{{ trans('home.Lưu') }}</button>
                      </div>
                    </div>
                  </div>
                </form>
            ...
            <form action="{{ route('customer-update') }}" class="mt-3" method="post">
              ...
              <div class="form-group mt-5">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="input" class="form-control input-info" name="name"
              ...
              <div class="form-group mt-4">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <!-- <input type="text" class="form-control input-info input-info__phone" name="phone" value="{{ $customer->phone }} 0349016282"> -->
                    <input type="text" class="form-control input-info input-info__phone" name="phone"
                      value=" 0349016282" disabled="true">
                  </div>
              ...
              <div class="form-group mt-3">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <input id="user-phone-info" type="input" class="form-control input-info input-info__phone"
                      name="email" title="cccccccccccccccccccccccccccccc@gmail.com"
                      value="cccccccccccccccccccccccccccccc@gmail.com" disabled="true">
                    <input type="input" class="form-control input-info" name="email"
                      value="{{ $customer->email }}" hidden="true">
                  </div>
                  <div class="col-sm-2 btn-info-change">
        ...
        <div class="modal-body">
          @if (empty($customer->phone))
            <input type="text" name="phone"
              class="form-control input-info input-change_phone  input-info__change"
              placeholder="Nhập số điện thoại bạn nào!!!" required pattern="(\+84|0)\d{9}">
          @else
            <input type="text" name="phone" class="form-control input-info input-change_phone "
              value="{{ $customer->phone }}" required pattern="(\84|0)\d{9}">
          @endif
        </div>
