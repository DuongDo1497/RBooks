          ...
          <div class="col-xxl-8">
            <div class="card account-body order-info">
              <div class="card-header">
                <h4 class="info-title">{{ trans('home.Quản lý đơn hàng') }}</h4>
              </div>
              <div class="card-body">
                <table class="table table-striped">
                  <thead class="table-thead">
                    <tr>
                      <th scope="col">{{ trans('home.Mã đơn hàng') }}</th>
                      <th scope="col">{{ trans('home.Ngày mua') }}</th>
                      <th scope="col">{{ trans('home.PT thanh toán') }}</th>
                      <th scope="col">{{ trans('home.Tổng tiền') }}</th>
                      <th scope="col">{{ trans('home.Trạng thái') }}</th>
                    </tr>
                  </thead>
                      ...
                      <tr>
                        ...
                        <td>
                          @switch($order->payment_method)
                            ...
                            @break;
                            @case(2)
                              {{ trans('home.Chuyển khoản ngân hàng') }}
                            @break;
                          @endswitch
                        </td>
