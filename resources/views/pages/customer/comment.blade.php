                ...
                <div class="col-xxl-8">
                    <div class="card account-body order-info">
                        <div class="card-header">
                            <h4 class="info-title">Sản phẩm đã mua</h4>
                        </div>
                        <div class="card-body">
                            ...
                            @foreach($comments as $comment)
                                <ul class="product-bought-list row row-cols-1 row-cols-sm-2 row-cols-md-4">
                                    <li class="product-bought-item col-3">
                                        ...
                                        <div class="product-bought-des"> <span class="des-product-bought">{{ $comment->products->first()->name }}</span> </div>
                                        <button class="write-comment-product btn-add" data-bs-toggle="modal" data-bs-target="#modalComment">Viết nhận xét</button>
