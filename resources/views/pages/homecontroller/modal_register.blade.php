    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="formRegister" action="{{ route('register') }}" method="POST" class="form-horizontal p-3">
                    @csrf
                    <div class="form-group row ">
                        <input type="text" id="ursRegister" class="form-control txt-field " name="name" autofocus placeholder="Tên tài khoản/Email"  >
                    ...
                    <div class="form-group row">
                        <input type="password" id="pwdRegister" class="form-control txt-field" name="password" placeholder="Mật khẩu" >
                    ...
                    <div class="form-group row">
                        <input type="password" id="confirmRegister" class="form-control txt-field" name="password_confirmation" placeholder="Xác nhận mật khẩu" >
                        <span><i id="icon-rePwd" class="icon-input fa-solid fa-eye icon-eye-rePwd eye-rePwd"></i></i></span>
                        <span><i id="icon-rePwd" class="icon-input fa-solid fa-eye-slash icon-eye-rePwd eye-slash-rePwd"></i></i></span>
                        <!-- <small>Error Message</small> -->
                    </div>
                    <small class="msg_confirm">Error Message</small>

                    <div class="float-right row ">
                        <button type="submit" class="btn btn-danger btn-modal w-100">Đăng ký</button>
            ...
            <div class="modal-footer p-2 pt-3">
                <div class="seperator" ><b style="color: #666666;"><p>hoặc</p></b></div>
