            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="detail-tab" data-bs-toggle="tab" data-bs-target="#detail" type="button"
                  role="tab" aria-controls="detail" aria-selected="false">Chi tiết sản phẩm</button>
              </li>
              <li class="nav-item" role="presentation">
                      ...
                      <div class="item">
                        <div class="comment-point">
                          ...
                          <div class="info">
                            @if (empty($comments->first()))
                              <div class="quantity">
                                <span class="quantity-num">0</span> nhận xét
                              </div>
                              <div class="rate">
        ...
        <div class="product-carousel">
          <div class="card">
            <div class="card-header">
              <h5 class="title">Sách cùng chủ đề</h5>
            </div>
            <div class="card-body">
    ...
    <div class="section section-books-topic">
      <div class="container">
        <div class="product-carousel">
          <div class="card">
            <div class="card-header">
              <h5 class="title">Sách bán chạy</h5>
            </div>
            <div class="card-body">
              <div class="owl-carousel owl-theme product product-detail-list vertical flex-nowrap">
