...
<body>
                ...
                <div class="footerTop-main">
                    ...
                    <div class="item">
                        ...
                        <ul class="footerTop-menu">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('recruitment') }}" class="menu-link">{{trans('home.Careers')}}</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('privacy') }}" class="menu-link">{{trans('home.PrivacyPolicy')}}</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('how-to-order') }}" class="menu-link">{{trans('home.Howtobuy')}}</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('payment') }}" class="menu-link">{{trans('home.PaymentMethods')}}</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('shipping-method') }}" class="menu-link">{{trans('home.ShippingRates&Policies')}}</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="item">
                        ...
                        <a class="footerTop-BCT" href="http://online.gov.vn/Home/WebDetails/36094" target="_blank">
                            <img class="img-fluid" src="{{ asset('/imgs/logo/dathongbao.png') }}" alt="Đã thông báo Bộ Công Thương">
                        </a>
                    </div>
                    ...
                    <div class="item">
                        ...
                        <ul class="footerTop-social d-none">
                            ...
                            <li class="menu-item">
                                <a href="https://www.youtube.com/channel/UC40qGVhqAYh-CO6zsCzyeIw?view_as=subscriber" class="menu-link" target="_blank">
    ...
    <noscript>
        <img height="1" width="1" src="https://www.facebook.com/tr?id=335646733514821&ev=PageView
    &noscript=1" />
    </noscript>
    <!-- Facebook Pixel Code -->
    <script>
    ...
    <noscript>
        <img height="1" width="1" src="https://www.facebook.com/tr?id=554248482025640&ev=PageView
        &noscript=1" />
    </noscript>
    <!-- Scripts FB -->
    <script>
